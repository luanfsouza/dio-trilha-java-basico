...
public class ExemploOrdenacaoSet {
    public static void main(String[] args) {
        ...
        Set<Serie> minhSeries2 = new TreeSet<>(new ComparatorNomeGeneroTempoEpisodio());
        minhSeries2.addAll(minhasSeries);
        for(Serie serie : minhSeries2) System.out.println(serie);
        System.out.println("------------------------------");
    }
}
